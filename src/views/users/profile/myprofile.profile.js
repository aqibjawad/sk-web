...
const MyProfile = () => {
    ...
    const submit = async (event) => {
        ...
        formData.append("address", emailRef.current.value);
            ...
            <div className=" mb-5 account-form" style={{ margin: "0 43px " }} >
                <form className="card-body">
                    <div className="form-group">
                        ...
                        {image && (
                            <div>
                                <img src={URL.createObjectURL(image)} className="bg-light rounded p-2 mb-2" height="220px" width="auto" />
                            </div>
                        )}
                    ...
                    <div className="row">
                        ...
                        <div className="form-group col-sm-6 pr-0">
                            ...
                            <input ref={lastnameRef} defaultValue={user.lastname}  type="text" className="rounded-0 bg-light form-control"
                    ...
                    <div className="row">
                        ...
                        <div className="form-group col-sm-6">
                            ...
                            <input ref={emailRef} defaultValue={user.email} type="email"
                                className="rounded-0 bg-light form-control" placeholder="email@example.com" />
                        </div>
                        ...
                        <div className="form-group col-sm-6">
                            ...
                            <input defaultValue={user.role} disabled  className="rounded-0 bg-light form-control" />
                        </div>
                        ...
                        <div className="form-group col-sm-6">
                            ...
                            <input defaultValue={user.address}  type="text" className="rounded-0 bg-light form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Enter Your Address" ref={addressRef}
                            />
                        </div>
