...
export default function JobInside() {
  ...
  useEffect(async () => {
    ...
    var result = await GET(`career/${list}`)
    setJob(result)
  }, [id])
      ...
      <Container>
        <Row className="px-md-4 py-5">
          ...
          <Col md={4} className='px-md-0'>
            <div>
              <Link to="#" className="border-bottom d-flex">
                <FontAwesomeIcon className="align-self-center title" style={{ fontSize: "12px" }} icon={faArrowLeft} />
                <h5 className="pl-1 text-uppercase title"> Roles at Stripe</h5>
              </Link>
              {jobs.map(jobs => (
                <div className="px-lg-4 px-2 px-md-0 py-3">
                  <div className="d-flex py-1 border-bottom">
                    <p>
                      <FontAwesomeIcon className="align-self-center " style={{ fontSize: "16px" }} icon={faGlobeAsia} />
                    </p>
                    <p className="pl-2">
                      {jobs.city}
                    </p>
                  ...
                  <Row className="py-lg-2  ">
                    <Col xs={2} className=" text-center icons">
                      <Link target="blank" to="#">
                        <FontAwesomeIcon style={{ fontSize: "24px" }} icon={faFacebookSquare} />
                      </Link>
                    </Col>

                    <Col xs={2} className="text-center icons">
                      <Link target="_blank" to="#">
                        <FontAwesomeIcon style={{ fontSize: "24px", color: "00acee" }} icon={faTwitter} />
                      </Link>
                    </Col>

                    <Col xs={2} className="text-center icons">
                      <Link target="_blank" to="#">
                        <FontAwesomeIcon style={{ color: "#1666C2", fontSize: "24px" }} icon={faLinkedin} />
                      </Link>
                    </Col>
                  </Row>
                </div>
              ...
              <div className="py-2">
                <Link to="#" className="btn-primary rounded apply-btn px-4 py-2" >
                  Apply Now
                </Link>
              </div>
            </div>
            ...
            <Col md={8} className="py-5 py-md-0">
              <div className="px-md-4 px-2 ">
                <div>
                  <div className="pb-4">
                    <h2> {job.title} </h2>
                    <p>Help us shape Citybook.com </p>
                  </div>
                  <h5>Design at City Book</h5>
                  <p className="py-2">
                    {job.description}
                  </p>
              ...
              <div className="py-lg-5 p-3 d-lg-flex justify-content-around rounded" style={{ backgroundColor: "#ffcccb " }} >
                ...
                <div className="pt-2 pt-lg-0 d-flex justify-content-end">
                  <Link to="#" className="btn-primary apply-btn rounded px-4 py-2" >
                    APPLY NOW
                  </Link>
                </div>
              </div>
